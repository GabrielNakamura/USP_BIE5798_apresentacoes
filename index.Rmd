...
## Ferramentas para organização local: Scripts
...
- [x] Montar um arquivo `.xml` usando o pacote `{EML}`

- [x] Montar um arquivo Darwin Core Archive usando o `{LivingNorwayR}`

- [x] Manipular um arquivo `.xml`
